        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between h-20 items-center">
                ...
                <div class="hidden md:flex space-x-8">
                    <a href="index.html" class="text-orange-500 font-semibold border-b-2 border-orange-500 pb-1">Accueil</a>
                    <a href="#" class="text-gray-600 hover:text-orange-500 font-medium transition">Recettes</a>
                    <a href="#" class="text-gray-600 hover:text-orange-500 font-medium transition">Communauté</a>
                    <a href="#" class="text-gray-600 hover:text-orange-500 font-medium transition">À propos</a>
                </div>
                ...
                <div class="flex items-center gap-4">
                    ...
                    <a href="inscription.html" class="bg-white border-2 border-orange-500 text-orange-500 px-5 py-2 rounded-xl hover:bg-orange-500 hover:text-white transition font-medium">
                        Inscription
                    </a>
                </div>
            </div>
